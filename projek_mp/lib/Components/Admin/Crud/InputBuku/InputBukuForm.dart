...
class FormInputBuku extends StatefulWidget {
  @override
  _FormInputBuku createState() => _FormInputBuku();
}

class _FormInputBuku extends State<FormInputBuku> {
          ...
          DefaultButtonCustomeColor(
            ...
            press: () {
              if (txtNamaBuku.text == '') {
                ...
                inputDataBuku(txtNamaBuku.text, txtPengarangBuku.text,
